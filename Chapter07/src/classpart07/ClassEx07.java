...
public class ClassEx07 {
	...
	String signUpPw = ""; // 회원가입 생성하려는 PW
	int signUpMoney = 1000; // 회원가입으로 주어지는 기본 계좌금액
	int cnt = 5; // 아이디, 비밀번호, 계좌 값의 개수
	String inputAcc = ""; // 로그인 하려는 ID
	String inputPw = ""; // 로그인 하려는 PW
	int inputMoney = 0; // 입금할 금액
	String transferAcc = ""; // 이체받을 계좌번호
	int transferLog = -1; // 이체받을 계좌번호의 위치
	int transferMoney = 0; // 이체할 금액
